...
## Quản lý Giao nhận (Smart TMS) `/tms`
Tối ưu hóa vận tải, quản lý đội xe và theo dõi hành trình giao hàng thời gian thực.

| Method | Path | Description |
| ------ | ---- | ----------- |
| GET    | `/tms/trips` | Danh sách các chuyến hàng (Trips) và trạng thái |
| GET    | `/tms/trips/:id` | Xem lộ trình chi tiết và các điểm dừng (Stops) |
| PATCH  | `/tms/stops/:id/confirm` | **Digital PoD**: Tài xế xác nhận giao hàng và ký nhận điện tử |
